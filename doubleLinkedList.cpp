...
void addNode() {
    ...
    if (START == NULL || newNode->noMhs <= START->noMhs) {
        ...
        while (current != NULL && current->noMhs < newNode->noMhs) {   //step 1.c: traverse the list to find the correct position
            ...
            current = current->next;   //step 1.e: miove the current to the next node
        }
...
void revtraverse() {
    if (listEmpty()) {
        ...
        cout << "\nRecords in descending order or roll number are: " << endl;
...
int main()
{
    while (true) {
        try {
            ...
            cout << "3. View all records in the ascending order or roll numbers" << endl;
            cout << "4. View all records in the descending order or roll numbers" << endl;
